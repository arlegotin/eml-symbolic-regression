...
- [x] **BASE-01**: Maintainer can run EML and conventional symbolic-regression baselines through one standardized harness using identical datasets, seeds, budgets, constants policies, and blind/warm-start conditions.
- [x] **BASE-02**: Baseline integrations are dependency-checked, source-locked, fail-closed, and reported without changing EML recovery denominators.
